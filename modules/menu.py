...
class Main(QMainWindow, BaseWindow):
    ...
    def toggle_mode(self):
        ...
        if not new_dark_mode:
            with open(Path(__file__).resolve().parent /"css/light.css", "r") as file:
                self.setStyleSheet(file.read())
            pixmap = QPixmap('modules/icons/BGL.png')
            self.label.setPixmap(pixmap)
            self.bgmode.setIcon(QIcon("modules/icons/DRKMODE.png"))
        else:

            with open(Path(__file__).resolve().parent /"css/dark.css", "r") as file:
                self.setStyleSheet(file.read())
            pixmap = QPixmap("modules/icons/BGD.png")
            self.label.setPixmap(pixmap)
            self.bgmode.setIcon(QIcon("modules/icons/LHTMODE.png"))
            ...
            if selected_items:
                ...
                if client_id_item:
                    ...
                    if edit_dialog.exec_() == QDialog.Accepted:
                        ...
                        self.db.insert_logs(self.user_id, date_today, time_today, 'edit client')
            else:
    ...
    def delete_selected_client(self, row):
        ...
        if client_id_item:
            ...
            self.db.insert_logs(self.user_id, date_today, time_today, 'delete client')
